...
//CImage*	CUIGuildList::m_pGuildNavyImg2=NULL;	// �޸ĳ� Label ��
...
//CImage*	CUIGuildList::m_pGuildPirateImg2=NULL;	// �޸ĳ� Label ��
...
void CUIGuildList::ShowGuildList()
{
	...
	//m_pGuildPirateImg2->SetIsShow(true);	// �޸ĳ� Label ��
	...
	//m_pGuildNavyImg2->SetIsShow(false);	// �޸ĳ� Label ��
