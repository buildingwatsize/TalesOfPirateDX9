...
//
	...
	void CSpiritMgr::_evtDragMarryItem(CGuiData *pSender,CCommandObj* pItem,bool& isAccept)
	{
		...
		{
			g_pGameApp->MsgBox(RES_STRING(CL_LANGUAGE_MATCH_698));	// "������Ĳ��Ƕ�ħ��ʵ��������ѡ���ħ��ʵ"
		}
	}
	...
	void CSpiritMgr::_evtDragMarryOne(CGuiData *pSender,CCommandObj* pItem,bool& isAccept)
	{
		...
		if(NULL == pStoneItem)
		{
			g_pGameApp->MsgBox(RES_STRING(CL_LANGUAGE_MATCH_826));//���ȷ����ħ��ʵ
			return;
		}

		if(! pItemCommand->GetIsValid())
		{
			g_pGameApp->MsgBox(RES_STRING(CL_LANGUAGE_MATCH_899));//������ľ��鲻�Ϸ���������ѡ����
			return;
		}
		...
		{
			g_pGameApp->MsgBox(RES_STRING(CL_LANGUAGE_MATCH_827));//������Ĳ��Ǿ�������ǵ���20���ľ��飬������ѡ����
		}
	}
