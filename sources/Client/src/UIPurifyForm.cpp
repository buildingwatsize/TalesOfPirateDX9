...
//
	...
	void CPurifyMgr::_evtDragPurifyOne(CGuiData *pSender,CCommandObj* pItem,bool& isAccept)
	{
		...
		if(g_stUIPurify.GetType() == CPurifyMgr::PURIFY_TYPE)
		{
			...
			//{
			//	g_pGameApp->MsgBox(RES_STRING(CL_LANGUAGE_MATCH_831)); // ��Ҫװ�����Ϸ���������ѡ��
			//	return;
			//}
		}
		// ����
		else if(g_stUIPurify.GetType() == CPurifyMgr::ENERGY_TYPE)
		{
			...
			{
				g_pGameApp->MsgBox(RES_STRING(CL_LANGUAGE_MATCH_852)); // ������Ĳ��Ǳ��ǣ�������ѡ��
				return;
			}
		}
		// ��ʯ
		...
		else if(g_stUIPurify.GetType() == CPurifyMgr::REPAIR_OVEN_TYPE)
		{
			...
			{
				g_pGameApp->MsgBox(RES_STRING(CL_LANGUAGE_MATCH_891)); // ������Ĳ�������ܹ��ߣ�������ѡ��
				return;
			}
		}
		else	// ���Ͳ��Ϸ�
	...
	void CPurifyMgr::_evtDragPurifyTwo(CGuiData *pSender,CCommandObj* pItem,bool& isAccept)
	{
		...
		if(g_stUIPurify.GetType() == CPurifyMgr::PURIFY_TYPE)
		{
			if(NULL == pMainItem)
			{
				g_pGameApp->MsgBox(RES_STRING(CL_LANGUAGE_MATCH_828)); // ���ȷ�����Ҫװ��
				return;
			}

			//if(pMainItem->GetItemInfo()->sType != pItemCommand->GetItemInfo()->sType)
			//{
			//	g_pGameApp->MsgBox(RES_STRING(CL_LANGUAGE_MATCH_829)); // �ᴿװ������Ҫװ������ͬһ���ͣ�������ѡ��
			//	return;
			//}

			//if(pMainItem->GetData().GetItemLevel() > pItemCommand->GetData().GetItemLevel() + 5)
			//{
			//	g_pGameApp->MsgBox(RES_STRING(CL_LANGUAGE_MATCH_830)); // �ᴿװ���ȼ�����С����Ҫװ�� 5 ����������ѡ��
			//	return;
			//}
		}
		// ����
		else if(g_stUIPurify.GetType() == CPurifyMgr::ENERGY_TYPE)
		{
			if(NULL == pMainItem)
			{
				g_pGameApp->MsgBox(RES_STRING(CL_LANGUAGE_MATCH_853)); // ���ȷ��뱴��
				return;
			}
		}
		// ��ʯ
		...
		else if(g_stUIPurify.GetType() == CPurifyMgr::REPAIR_OVEN_TYPE)
		{
			if(NULL == pMainItem)
			{
				g_pGameApp->MsgBox(RES_STRING(CL_LANGUAGE_MATCH_892)); // �������������ܹ���
				return;
			}

			if(! g_stUIPurify.IsRepairLifeItem(*pItemCommand))
			{
				g_pGameApp->MsgBox(RES_STRING(CL_LANGUAGE_MATCH_893)); // ������Ĳ����޲����ߣ�������ѡ��
				return;
			}
		}
		// ���Ͳ��Ϸ�
